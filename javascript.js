...
form.addEventListener("submit", function(event) {
  //each time the user tries to send the data we are going to check if the email field is valid 
  if(!email.validity.valid) {
...
var header = document.querySelector('header');
    ...
    var requestURL = 'https://raw.githubusercontent.com/ShivamMalhotra0105/WeirdDeals/master/threeDeals.json';
